...
public class Main {
    public static void main(String[] args) {
        ...
        while(userInput.toUpperCase().compareTo("Q") != 0){
            ...
            System.out.println("8. Solution. See the solution");
    ...
    public static String[] Solution() {
        ...
        for (int i = 0; i < m.length; i++) {
            for (int j = 0; j < m[0].length; j++) {
                // Create an algorithm that can solve the maze if we know that the maze is solvable.
                // Print in the format: LLFFRRFFRRFFLLFF
                // L = turn left, R = turn right, F = move forward.


                if (m[i-1][j] == 6 && m[i][j+1] == 6) {
                    ar.add("L");
                    ar.add("F");
                }
                if (m[i+1][j] == 6 && m[i][j+1] == 6) {
        ...
        String[] solution = new String[ar.size()];
    ...
    public static void level2(){
        ...
        if(coordinate == null)
            System.out.println("Too easy, try a bigger maze.");
        else
    ...
    public static void level6(){
        ...
        while(find(m, 5) != null){
            ...
            clearScreen();
            printMap(m);
            System.out.println("Help me by modifying the level6() function!");
        }
